...
public class ConversationStoreTest {
	...
	public void testGetConversationById() {
		final Conversation convo1 = new TestConversationBuilder()
				.withId(UUID.fromString("20000000-2222-3333-4444-555555555555")).build();
		final Conversation convo2 = new TestConversationBuilder().withTitle("some title 1").build();
		final Conversation convo3 = new TestConversationBuilder().build();
		conversationStore.setConversations(Arrays.asList(convo1, convo2, convo3));

		Conversation resultConversation = conversationStore
				.getConversationById(UUID.fromString("20000000-2222-3333-4444-555555555555"));
	...
	public void testAddConversation() {
		...
		final Conversation inputConversation = new TestConversationBuilder().withTitle("test_conversation").build();
